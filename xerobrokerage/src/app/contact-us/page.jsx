      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-black/10 rounded-2xl shadow-xl overflow-hidden"
          >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        className="block w-full px-4 py-3 rounded-lg bg-black/10"
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full bg-black/90 hover:bg-black text-white poppins-bold py-3 px-4 rounded-lg shadow-md flex items-center justify-center"
                    >
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-black/10 text-black rounded-2xl shadow-xl overflow-hidden"
          >
            <div className="p-8 sm:p-10 h-full">
              ...
              <div className="space-y-8">
                <motion.div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-black">contact@zerobrokerage.com</p>
                  </div>
                </motion.div>
              ...
              <div className="mt-12 bg-black/10 bg-opacity-10 p-6 rounded-xl">
                <h3 className="text-lg text-blue-900 font-medium mb-3">
                  Office Hours
                </h3>
