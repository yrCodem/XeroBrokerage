      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <header className='text-center mb-12'>
          <h1 className='text-3xl font-bold text-gray-900 mb-4 flex items-center justify-center'>
            <FiShield className='mr-3 text-blue-600' size={28} />
            Privacy Policy
          </h1>
        ...
        <section className='mb-12 bg-white p-6 rounded-lg shadow-sm'>
          ...
          <div className='space-y-6 pl-14'>
            ...
            <div className='bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400'>
              <h4 className='font-medium text-gray-700 mb-2'>Important Note</h4>
              <p className='text-gray-600'>
        ...
        <section className='bg-blue-50 p-8 rounded-lg text-center'>
          <h3 className='text-xl font-medium text-gray-700 mb-4'>Contact Us</h3>
          <p className='text-gray-600 mb-4'>
            If you have any questions about this Privacy Policy, please contact
            us:
          </p>
          <div className='space-y-2'>
            <p className='text-gray-600'>By email: privacy@zerobrokerage.com</p>
            <p className='text-gray-600'>By phone: +1 (800) 123-4567</p>
            <p className='text-gray-600'>
