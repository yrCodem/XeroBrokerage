    ...
    <div className='fixed inset-0 overflow-hidden bg-gray-50'>
      <div className='absolute inset-0 flex justify-center items-center p-5'>
        <form
          ...
          className='w-full max-w-md max-h-[calc(100vh-40px)] overflow-y-auto bg-white rounded-xl shadow-lg p-10 flex flex-col gap-5 animate-fade-in hover:shadow-xl transition-shadow'
        >
          ...
          <div className='flex flex-col gap-2'>
            ...
            <div
              className={`flex items-center border rounded-lg h-12 px-3 bg-gray-50 transition-colors ${
                errors.name
                  ? 'border-red-500'
          ...
          <button
            ...
            className={`mt-2 w-full h-12 rounded-lg font-medium text-white transition-all ${
              isSubmitting
